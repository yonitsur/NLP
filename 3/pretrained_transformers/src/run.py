...
if __name__ == '__main__':
    ...
    if args.variant == 'vanilla':
        ...
        # finetune a Transformer model on the name/birthplace dataset, via examples from the NameDataset class.
        # implement the case without pretraining (i.e. create a model from scratch and train it on the birthplace dataset).
    ...
    if args.function == 'pretrain':
        # print(pretrain_dataset.__getitem__(0))
        ...
        if args.eval_corpus_path is not None:
            ...
            eval_dataset = dataset.NameDataset(pretrain_dataset, open(args.eval_corpus_path).read())
        else:
            # If not provided
            eval_dataset = None
